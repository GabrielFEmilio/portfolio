...
window.SITE_CONFIG = {
  ...
  i18n: {
    pt: {
      ...
      about_kicker: "Sobre",
      about_title: "Mentalidade de engenharia, visão de produto.",
      about_p1: "Eu trabalho na interseção entre profundidade técnica e visão de mercado. Penso em sistemas: arquitetura limpa, performance no detalhe e decisões que escalam.",
      about_p2: "Aprendizado contínuo impulsiona novas linguagens, novas tecnologias e novos idiomas. Busco problemas difíceis e os resolvo com discernimento, não com força bruta.",
    ...
    en: {
      ...
      about_kicker: "About",
      about_title: "Engineering mindset, product vision.",
      about_p1: "I work at the intersection of technical depth and market vision. I think in systems: clean architecture, performance in the details, and decisions that scale.",
      about_p2: "Continuous learning drives new languages, new technologies and new idioms. I seek out hard problems and solve them with judgment, not brute force.",
    ...
    fr: {
      ...
      about_title: "Mentalité d'ingénieur, vision produit.",
      about_p1: "Je travaille à l'intersection de la profondeur technique et de la vision marché. Je pense en systèmes : architecture propre, performance dans le détail et décisions qui passent à l'échelle.",
      about_p2: "L'apprentissage continu nourrit de nouveaux langages, de nouvelles technologies et de nouvelles langues. Je cherche les problèmes difficiles et les résous avec discernement.",
